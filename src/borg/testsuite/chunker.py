...
class ChunkerTestCase(BaseTestCase):
    ...
    def test_chunkify(self):
        ...
        self.assert_equal(cf(Chunker(0, 2, CHUNK_MAX_EXP, 2, 3).chunkify(BytesIO(b'foobarboobaz' * 3))),
                          [b'foobarboobaz' * 3])
        ...
        self.assert_equal(cf(Chunker(0, 3, CHUNK_MAX_EXP, 2, 3).chunkify(BytesIO(b'foobarboobaz' * 3))),
                          [b'foobarboobaz' * 3])
    ...
    def test_buzhash(self):
        ...
        self.assert_equal(buzhash(b'abcdefghijklmnop', 1), buzhash_update(buzhash(b'Xabcdefghijklmno', 1),
                          ord('X'), ord('p'), 16, 1))
